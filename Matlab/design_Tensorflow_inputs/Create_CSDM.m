% written by Dr. Haiqiang Niu, Winter 2017
% modified by Emma Ozanich, Spring 2017
%%
%run two times, once for training data and once for test data. 
% set flag TRAIN = true or false
% % % Edit this section % % % % % % % % % % %
DataSet = '01';
data_Dir = ['../../data/DataSet' DataSet '/'];
%%% EITHER TRAIN
filename = 'AcousticData_255190605_255192105'; %training data set, TRAIN = true
TRAIN = true;
% OR TEST
%filename = 'AcousticData_256093210_256094810'; % test data set, TRAIN = false
%TRAIN = false; %% 
%%%%%%%%%%
...
if TRAIN
    save([data_Dir 'train_input/SBCEx16_train_input.txt'],'-ascii', 'x_output');
else
    save([data_Dir 'test_input/SBCEx16_test_input.txt'],'-ascii', 'x_output');
end
